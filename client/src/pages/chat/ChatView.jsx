...
import { ArrowLeft, Send, FileText, Bot, Trash2, FileDown } from "lucide-react";
...
const ChatView = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (id) {
      ...
      // For multi-document chat, we would use chatWithMultipleDocuments here
  ...
  // Filter chat history for this document
  const filteredChatHistory = id && chatHistory[id] ? chatHistory[id] : [];
            ...
            {filteredChatHistory.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center p-6">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-md">
                  Ask questions about your document and I'll provide answers
